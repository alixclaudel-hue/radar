...
Streamlit retiré — détail dans `CLAUDE.md`). Restent bloquées : l'étape 4 (HTTPS +
domaine) et la 5b (OAuth Discogs/Spotify), ci-dessous. Historique complet des étapes
...
| Risque | Parade |
|---|---|
| Stockage des tokens Discogs/Spotify d'autres personnes | chiffrement au repos ; HTTPS ; hash argon2 pour les mots de passe applicatifs |
