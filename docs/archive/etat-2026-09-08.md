...
- Admin privé (Tailscale) et manuel VPS (SSH, dépannage) : coordonnées dans la note perso
  non versionnée (cf. `CLAUDE.md` point 2) — retirées d'ici lors du ménage du 2026-09-08.
- Backups VPS : `/data/backups/data-*.tgz.enc`, cron hôte 04:00 UTC, passphrase dans la
  même note perso. Restauration : `docs/backup.md`.
